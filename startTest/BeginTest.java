...
public class BeginTest extends JPanel {
	...
	private static String[] computeResult()
	{
		...
		Result[0]=courseName;
		Result[1]=time;
		Result[2]=""+totalQuestions;  
		Result[3]=""+QuestionPanel.q_attempted;
		Result[4]=""+CQ;
		Result[5]=""+(QuestionPanel.q_attempted-CQ);
		Result[6]=""+(CQ*eachMarks);
		Result[7]=""+(totalQuestions*eachMarks);
		Result[8]=""+(((float)(CQ*eachMarks)/(totalQuestions*eachMarks))*100);
		return Result;
	}
	
	private void executeQuery()
	{
		Connect c=new Connect("root","HenCarSal2001");
		try{
